...
def analyze_session_asymps(session, num_PCs, post, nlag, binsize, sigma):
    try:
        ...
        return (r1_rsquare, r1_sw_rsquare), (r2_rsquare, r2_sw_rsquare), (X_l, X_c), (Y_l, Y_c)
...
pdump(session_output,
        f'../../picklejar/toSweepRegsSW_{nlag}nlag_{post}post_{sw_weight}sw.pickle')
pdump(session_asymps,
        f'../../picklejar/toSweepRegsSWasymps_{nlag}nlag_{post}post_{sw_weight}sw.pickle')
