...
pdump(session_output,
        f'../../picklejar/coSweepRegsAll_{nlag}nlag_{post}post_{sw_weight}sw.pickle')
pdump(session_asymps,
        f'../../picklejar/coSweepRegsAllasymps_{nlag}nlag_{post}post_{sw_weight}sw.pickle')
