...
high_lasers = laser_bounds[powers==2,:]
...
session.sw = session.getSWs(bigBound = all_bounds, smallBound = high_lasers,
        sw_weight=20, binsize=binsize, nlags=nlags)
...
pdump(output, '../../picklejar/to5_06202024_highlasers_SweepRegs.pickle')
pdump(inputs, '../../picklejar/to5_06202024_highlasers_SweepRegs_inputs.pickle')
