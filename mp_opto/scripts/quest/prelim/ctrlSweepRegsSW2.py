...
pdump(session_output, f'../../picklejar/bulkSweepRegsSW_{nlag}nlag_{post}post_10sw.pickle')
pdump(session_asymps, f'../../picklejar/bulkSweepRegsSWasymps_{nlag}nlag_{post}post_10sw.pickle')
