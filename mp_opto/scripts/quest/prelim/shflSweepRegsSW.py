...
pdump(session_output, f'../../picklejar/bulkSweepRegsSW_{nlag}nlag_{post}post.pickle')
pdump(session_asymps, f'../../picklejar/bulkSweepRegsSWasymps_{nlag}nlag_{post}post.pickle')
